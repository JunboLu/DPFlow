...
def get_dump(keyword_block, keyword_block_index, inp):
  ...
  sys_num = 0
  for i in range(len(keyword_block)):
    if ( keyword_block[i] == 'new_data_dir' ):
      keyword_block[i] = 'new_data_dir' + str(sys_num)
      sys_num = sys_num + 1
...
if __name__ == '__main__':
  from DPFlow.analyze import read_input
  work_dir = '/home/lujunbo/code/github/DPFlow/example/analyze/coord_num'
  inp_file = 'input.inp'
  f_key = ['geometry']
