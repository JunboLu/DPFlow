...
def write_restart_inp(inp_file_name, restart_iter, restart_stage, data_num, work_dir):
  ...
  restart_inp_file_name = ''.join((work_dir, '/DPFlow.restart'))
  ...
  line_7_num = file_tools.grep_line_num('max_force_conv', inp_tmp_file_name, work_dir)
  line_8_num = file_tools.grep_line_num('&end active_learn', inp_tmp_file_name, work_dir)[0]
  ...
  for i in [line_2_num, line_3_num, line_4_num, line_5_num, line_6_num, line_7_num]:
    if ( i != 0 ):
  ...
  for i in range(line_8_num, whole_line_num+1, 1):
